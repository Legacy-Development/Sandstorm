    ...
    msg.channel.send(embed);
      ...
      img = 15;
        ...
        switch(random) {
          ...
          case 6: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646878920896937994/FB_IMG_1574288167967.jpg"); break;
          case 7: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/647601347121643530/IMG_20191115_141557.jpg"); break;
          case 8: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/647518558473158676/IMG-20191122-WA0002.jpg"); break;
          case 9: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/647462630818054154/SmartSelect_20191121-114927_iFunny.jpg"); break;
          case 10: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646938824387067905/3bbe190.jpg"); break;
          case 11: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646514094563917834/This_person_is_GAY.png"); break;
          case 12: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646387929513590834/IMG-20191119-WA0007.jpg"); break;
          case 13: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646387412141998082/image0.jpg"); break;
          case 14: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646385018960347169/image0.jpg"); break;
          case 15: embed.setImage("https://cdn.discordapp.com/attachments/513941759164940308/646381374630133761/images_21.jpeg"); break;
        }
        embed.setColor("RANDOM")
      ...
      if(cmd == "edmsong") {
        songs = 5;
        let random = Math.floor(Math.random() * (songs + 1 - 1)) + 1;
        const embed = new Discord.RichEmbed();
        embed.setTitle(`Un buen tema perteneciente a un subgénero del EDM`)
        embed.setColor("#ffcc00")
        embed.setDescription(`Te recomendamos este tema`)
        switch(random) {
               case 1: embed.addField("Te recomendamos:", "Virtual Riot - Preset Junkies VIP (Riddim Dubstep)"); break;
               case 2: embed.addField("Te recomendamos:", "CloudNone - None Trick Pony (Electronic)"); break;
               case 3: embed.addField("Te recomendamos:", "Calcium - Mega Punch VIP (Dubstep)"); break;
               case 4: embed.addField("Te recomendamos:", "Silva Hounds - Shadows (Complextro/House)"); break;
               case 5: embed.addField("Te recomendamos:", "Oliverse - Something Good (Dubstep)"); break;
        }
        msg.channel.send(embed);
      }
